  ...
  return (
    <section className='mt-20'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2'>
       ...
       <div className='p-5 sm:p-10 md:p-10 lg:p-15 xl:p-20'>
          <motion.img
          ...
          animate="animate"
          >
            <Link to="/registros"  className='bg-red-600 py-2 px-12 rounded-2xl text-white hover:bg-black-700 
        ...
        {/* imagen */}
        <motion.div 
        className='p-5 sm:p-10 md:p-10 lg:p-15 xl:p-20'
